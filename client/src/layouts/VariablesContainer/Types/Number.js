    ...
    return (
      <div className={`VariableWrapper ${this.state.showSettings ? "settings-open" : ""}`}>
        <div className="variable" onClick={() => this.toggleSettings()}>
          <div className="variable-meta">
            <div className="file-type">
              <img src={NumberIcon} alt="Decoration" />
            </div>
            <div className="file-name">
              <h4>Number</h4> {/*Change This*/}
        ...
        <div className="settings" onClick={this.stopProp} style={{ display }}>
          ...
          <label>Value</label>
          <input type="number" name="value" value={this.state.value !== undefined ? this.state.value : this.props.element.value} onChange={this.onChange} />
        </div>
      </div>
    );
  }
...
export default connect(mapStateToProps, { updateVariable, deleteVariable })(Number);
